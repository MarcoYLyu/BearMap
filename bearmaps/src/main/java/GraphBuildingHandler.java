...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private LinkedList<Long> posConnections = new LinkedList<>();
    boolean validWayFlag = false;
    private long wayID;
...
//            System.out.println("Node lat: " + attributes.getValue("lat"));
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (qName.equals("way")) {
            if (validWayFlag) {
                g.addEdge(wayID, posConnections);
            }
            posConnections = new LinkedList<>();
            validWayFlag = false;
